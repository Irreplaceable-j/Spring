...
class BookRepositoryTest {
    ...
    public void selectById() {
        log.info("all books : {} ", bookRepository.selectById(1000));
    }
    ...
    public void update(){
        ...
        book.setAuthor("샌델");
        log.info("update book : {} ", bookRepository.update(book));
    }
    ...
    public void selectIf(){
        log.info("{}", bookRepository.selectByIf("author", "란"));
    }

    @Test
    public void selectByChooseWhen(){
        log.info("{}", bookRepository.selectByChooseWhen("author", "정당"));
    }
