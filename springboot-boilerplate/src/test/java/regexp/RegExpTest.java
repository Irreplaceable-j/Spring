...
public class RegExpTest {
    ...
    // 정규표현식 : 패턴에 일치하는 문자열을 검색, 치환, 추출하는데 사용되는 표현식
    ...
    void pracRegExp1(){
        ...
        assertFalse(pattern.matcher("992222-1222222").matches());
    }
    ...
    void testSpecial(){
        ...
        Pattern pattern = Pattern.compile(reg);
        assertTrue(pattern.matcher("991212-1222222").matches());
        assertFalse(pattern.matcher("991922-1222222").matches());
    ...
    void testGroup(){
        ...
        // 3번쨰 자리에 1이 올 경우 4번째 자리는 0,1,2만 올 수 있다.

        // 주민등록번호의 다섯번째 자리에는 0~3tkdldml 숫자만 올 수 있다.
